...
new to you. A "Can make now" filter chip narrows the card list to the same set, and a filter
that matches nothing now says why instead of leaving the page blank.
